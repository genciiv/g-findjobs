    ...
    <section className="favorites-page">
      <div className="favorites-container">
        <div className="favorites-header">
          <span className="favorites-badge">Punët e ruajtura</span>
          <h1>Shiko punët që ke ruajtur</h1>
          <p>
            Këtu mund të rikthehesh te punët që të kanë pëlqyer dhe t’i shohësh më vonë.
          </p>
        </div>
